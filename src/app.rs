    ...
    view! {
        ...
        <html lang="en">
            <head>
                ...
                <script
                    src="https://unpkg.com/@grafana/faro-web-sdk@1.9.0/dist/bundle/faro-web-sdk.iife.js"
                    defer="true"
                />
                <script>
    ...
    view! {
        <nav class="navbar">
            ...
            <ul class="nav-menu desktop-only">
                <li>
                    <A href="/" attr:class="nav-link">
                        {move || t!(lang, "Shop", "Cửa hàng")()}
                    </A>
                </li>
                <li>
                    <A href="/about" attr:class="nav-link">
                        {move || t!(lang, "About", "Giới thiệu")()}
                    </A>
                </li>
            </ul>
            <div class="nav-actions" style="display: flex; align-items: center; gap: 16px;">
                ...
                >
                    <div class=move || {
                        if menu_open.get() { "burger-icon open" } else { "burger-icon" }
                    }>
                        <span></span>
                        <span></span>
                        <span></span>
            ...
            <div class=move || if menu_open.get() { "mobile-menu open" } else { "mobile-menu" }>
                <ul class="mobile-nav-links">
                    <li>
                        <A on:click=toggle_menu href="/" attr:class="mobile-nav-link">
                            {move || t!(lang, "Shop", "Cửa hàng")()}
                        </A>
                    </li>
                    <li>
                        <A on:click=toggle_menu href="/about" attr:class="mobile-nav-link">
                            {move || t!(lang, "About", "Giới thiệu")()}
                        </A>
                    </li>
                    ...
                    <li style="margin-top: 24px; width: 100%;">
                        <a
                            ...
                            style="width: 100%; text-align: center; display: block; padding: 12px; font-size: 1rem;"
                        >
                            {move || t!(lang, "Shopee Store", "Cửa hàng Shopee")()}
                        </a>
                    </li>
...
fn HomePage() -> impl IntoView {
    ...
    view! {
        <SeoHead
            ...
            description="Shop ergonomic 3D printed keyboards with open-source designs, custom switches, and premium keycaps."
                .to_string()
            path="/".to_string()
        ...
        <div class="hero">
            <span class="hero-tag">
                {t!(lang, "Revolutionary Mechanical Keyboards", "Bàn Phím Cơ Đột Phá")}
            </span>
            <h1 class="hero-title">
                {t!(lang, "Ergonomic ", "Bàn Phím ")} <br />
                <span class="gradient-text">
                    {t!(lang, "3D Printed Keyboards", "In 3D Công Thái Học")}
                </span>
            </h1>
            ...
            <div class="hero-actions">
                <A href="/shop" attr:class="btn btn-primary">
                    {t!(lang, "Browse Products", "Xem sản phẩm")}
                </A>
                <A href="/about" attr:class="btn btn-secondary">
                    {t!(lang, "Our Philosophy", "Triết lý thiết kế")}
                </A>
            </div>
        ...
        <section
            class="faq-section"
            style="max-width: 1200px; margin: 0 auto; padding: 40px 0 20px;"
        >
            <div class="section-header">
                ...
                <h2 class="section-title">
                    {t!(
                        lang, "Keyboard buying questions, answered.", "Giải đáp thắc mắc về bàn phím"
                    )}
                </h2>
                <p class="section-subtitle">
                    {t!(
            ...
            <div class="grid grid-cols-3" style="gap: 18px;">
                <details class="glass-card feature-card" open>
                    <summary style="cursor: pointer; font-weight: 700;">
                        {t!(
                            lang, "What makes open-diy different?", "Sự khác biệt của open-diy là gì?"
                        )}
                    </summary>
                ...
                <details class="glass-card feature-card">
                    <summary style="cursor: pointer; font-weight: 700;">
                        {t!(
                            lang, "Can I build an ergonomic keyboard here?", "Tôi có thể mua bàn phím công thái học ở đây không?"
                        )}
                    </summary>
                    <p style="margin-top: 12px;">
                        {t!(
                ...
                <details class="glass-card feature-card">
                    <summary style="cursor: pointer; font-weight: 700;">
                        {t!(
                            lang, "Do you support DIY builders?", "Các bạn có hỗ trợ người tự build (DIY) không?"
                        )}
                    </summary>
                    <p style="margin-top: 12px;">
                        {t!(
...
fn CatalogPage() -> impl IntoView {
    ...
    view! {
        <SeoHead
            ...
            description="Browse curated ergonomic keyboard builds including Dactyl, Frosted 60%, and Alice Curved layouts with 3D printed cases."
                .to_string()
            path="/".to_string()
        ...
        <section class="catalog-section" id="catalog">
            <div class="section-header">
                ...
                <h2 class="section-title">
                    ...
                    <span class="gradient-text">
                        {t!(lang, "Curated Builds", "Custom Tuyển Chọn")}
                    </span>
                </h2>
                <p class="section-subtitle">
                    {t!(
                        lang, "Browse our professional ergonomic layouts and order securely on Shopee.", "Xem các bố cục công thái học chuyên nghiệp của chúng tôi và đặt hàng an toàn qua Shopee."
                    )}
                </p>
            </div>
            <div
                class="glass-card"
                style="max-width: 1200px; margin: 0 auto 28px auto; padding: 20px 24px;"
            >
                                ...
                                <div class=card_class>
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-meta">
                                            ...
                                            <A href=detail_url_3 attr:class="btn btn-primary btn-sm">
                                                {t!(lang, "View Details", "Chi tiết")}
                                            </A>
                                        </div>
                                    </div>
                                </div>
...
fn KeyboardCustomizer(
    ...
    view! {
        <div
            class="customizer-container glass-card"
            style="display: grid; grid-template-columns: 1fr; gap: 30px; padding: 24px; border-radius: 16px;"
        >
            ...
            >
                ...
                <svg
                    ...
                    height="280"
                    viewBox="0 0 600 300"
                    style="background: rgba(0,0,0,0.4); border-radius: 12px; border: 1px solid var(--border-color); box-shadow: inset 0 0 40px rgba(0,0,0,0.6);"
                >
                    // Coiled Cable
                    <path
                        d="M 220 150 C 230 110, 240 110, 250 150 C 260 190, 270 190, 280 150 C 290 110, 300 110, 310 150 C 320 190, 330 190, 340 150 C 350 110, 360 110, 380 150"
                        fill="none"
                        stroke=move || cable_color.get()
                        stroke-width="8"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                    ...
                    <path
                        d="M 50 100 Q 130 70 210 100 Q 230 150 210 220 Q 130 250 50 220 Q 30 150 50 100 Z"
                        fill=move || case_color.get()
                    ...
                    // Left Thumb cluster
                    <path
                        d="M 180 180 Q 220 190 220 230 Q 180 250 150 230 Z"
                        fill=move || case_color.get()
                        stroke="rgba(255,255,255,0.15)"
                        stroke-width="2"
                        style="transition: fill 0.3s ease;"
                    ...
                    // Right Hand Case
                    <path
                        d="M 550 100 Q 470 70 390 100 Q 370 150 390 220 Q 470 250 550 220 Q 570 150 550 100 Z"
                        fill=move || case_color.get()
                        stroke="rgba(255,255,255,0.15)"
                        stroke-width="3"
                        style="transition: fill 0.3s ease;"
                    ...
                    // Right Thumb cluster
                    <path
                        d="M 420 180 Q 380 190 380 230 Q 420 250 450 230 Z"
                        fill=move || case_color.get()
                        stroke="rgba(255,255,255,0.15)"
                        stroke-width="2"
                        style="transition: fill 0.3s ease;"
            ...
            >
                ...
                <div style="border-top: 1px solid var(--border-color); padding-top: 20px; margin-top: 10px;">
                    ...
                    <p style="font-size: 0.75rem; color: var(--text-muted); margin-top: 8px; text-align: center; line-height: 1.4;">
                        {t!(
                            lang, "* The configuration will be copied to your clipboard.", "* Cấu hình chi tiết sẽ được tự động sao chép vào bộ nhớ tạm."
                        )}
                    </p>
                </div>
            </div>
...
fn HandEstimator(lang: RwSignal<Language>) -> impl IntoView {
    ...
    view! {
        <div
            class="estimator-container glass-card"
            style="padding: 24px; border-radius: 16px; display: grid; grid-template-columns: 1fr; gap: 30px;"
        >
            ...
            <div
                ...
                style="background: rgba(0,0,0,0.25); border: 1px solid var(--border-color); border-radius: 12px; padding: 20px; display: flex; flex-direction: column; gap: 12px;"
            >
                <span
                    class="hero-tag"
                    style="align-self: flex-start; margin-bottom: 0; font-size: 0.75rem; padding: 4px 10px;"
                >
                ...
                <div style="border-top: 1px solid var(--border-color); padding-top: 10px; margin-top: 5px; font-size: 0.8rem; color: var(--secondary); display: flex; align-items: center; gap: 6px;">
                    ...
                    <span>
                        {t!(
                            lang, "Optimized for anatomical alignment", "Được tối ưu hóa theo cấu trúc sinh học cổ tay"
                        )}
                    </span>
                </div>
            </div>
...
fn SoundTestPlayer(lang: RwSignal<Language>) -> impl IntoView {
    ...
    view! {
        <div
            class="sound-test-container glass-card"
            style="padding: 24px; border-radius: 16px; display: flex; flex-direction: column; gap: 20px;"
        >
            <h3 style="font-size: 1.15rem; color: #fff; margin: 0; text-transform: uppercase; letter-spacing: 0.05em; font-weight: 700; color: var(--secondary);">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; margin-top: 10px;">
                ...
                >
                    ...
                    <p style="margin: 0; font-size: 0.8rem; color: var(--text-muted); line-height: 1.4;">
                        {t!(
                            lang, "Deep, silent, thocky tone. Smooth keypress travel.", "Âm thanh trầm ấm (Thocky), gõ êm mượt không có khấc cản."
                        )}
                    </p>
                </button>
                ...
                >
                    ...
                    <p style="margin: 0; font-size: 0.8rem; color: var(--text-muted); line-height: 1.4;">
                        {t!(
                            lang, "Moderate bump, round clack. Crisp tactile typing feedback.", "Cực kỳ cơ học với khấc cản nhẹ. Âm thanh clack tròn trịa."
                        )}
                    </p>
                </button>
                ...
                >
                    ...
                    <p style="margin: 0; font-size: 0.8rem; color: var(--text-muted); line-height: 1.4;">
                        {t!(
                            lang, "Loud double-click snap. High pitched typewriter tone.", "Âm thanh click đanh giòn như tiếng máy đánh chữ truyền thống."
                        )}
                    </p>
                </button>
            </div>
                ...
                .map(|p| {
                    ...
                    view! {
                        ...
                        <section
                            ...
                            style="max-width: 1200px; margin: 0 auto; padding: 60px 4% 100px 4%;"
                        >
                            <div style="margin-bottom: 24px;">
                                <A
                                    href="/"
                                    attr:style="color: var(--secondary); text-decoration: none; font-weight: 500; display: inline-flex; align-items: center; gap: 6px;"
                                >
                                    <svg
                                        width="18"
                                        height="18"
                            ...
                            <div class="builder-container">
                                ...
                                <div class="builder-preview-pane">
                                    <div
                                        ...
                                        style="aspect-ratio: 16/10; overflow: hidden; border-radius: var(--radius-lg); border: 1px solid var(--border-color); background: rgba(255,255,255,0.02);"
                                    >
                                        <img
                                            src=selected_img
                                    ...
                                    <div
                                        ...
                                        style="display: flex; gap: 12px; margin-top: 14px; margin-bottom: 24px;"
                                    >
                                        {images_gallery
                                            .into_iter()
                                            .map(|img_url| {
                                                ...
                                                let is_active = move || {
                                                    selected_img.get() == img_url_clone1
                                                };
                                                view! {
                                                    <button
                                                        on:click=move |_| {
                                                            set_selected_img.set(img_url_clone2.clone())
                                                        }
                                                        type="button"
                                                        style=move || {
                                                            if is_active() {
                                ...
                                <div class="builder-controls-pane">
                                    <div
                                        class="glass-card"
                                        style="display: flex; flex-direction: column; gap: 20px; padding: 28px;"
                                    >
                                        <div>
                                            <span class="hero-tag" style="margin-bottom: 10px;">
                                                {p.tag(current_lang)}
                                            </span>
                                            <h1
                                                class="gradient-text"
                                                style="font-size: 2.3rem; margin-top: 5px; line-height: 1.2;"
                                            >
                                                {name.clone()}
                                            </h1>
                                        ...
                                        <div style="display: flex; flex-direction: column; gap: 12px; border-top: 1px solid var(--border-color); border-bottom: 1px solid var(--border-color); padding: 20px 0;">
                                            <a
                                                ...
                                                rel="noopener noreferrer"
                                                class="btn btn-secondary"
                                                style="width: 100%; opacity: 0.85; display: flex; align-items: center; justify-content: center;"
                                            >
                                                <svg
                                                    width="18"
                                                    height="18"
                                                ...
                                                {t!(
                                                    lang, "Customize & Buy on Shopee (Coming Soon)", "Tùy biến & Mua trên Shopee (Sắp mở)"
                                                )}
                                            </a>
                                            ...
                                            >
                                                ...
                                                {t!(
                                                    lang, "Order Direct via Messenger (Pre-order)", "Đặt hàng trực tiếp qua Messenger (Pre-order)"
                                                )}
                                            </a>
                                                        ...
                                                        view! {
                                                            <li style="display: flex; align-items: flex-start; gap: 8px; color: var(--text-main); font-size: 0.88rem; line-height: 1.4;">
                                                                <svg
                                                                    ...
                                                                    stroke-linecap="round"
                                                                    stroke-linejoin="round"
                                                                    style="color: var(--secondary); flex-shrink: 0; margin-top: 2px;"
                                                                >
                            ...
                            <div
                                class="interactive-experience-section"
                                style="margin-top: 60px; margin-bottom: 20px;"
                            >
                                <div class="section-header">
                                    <span class="hero-tag" style="margin-bottom: 12px;">
                                        {t!(lang, "Hands-On", "Tương tác")}
                                    </span>
                                    <h2 class="section-title">
                                        {t!(lang, "Interactive ", "Trải nghiệm ")}
                                        <span class="gradient-text">
                                            {t!(lang, "Studio", "Trực quan")}
                                        </span>
                                    </h2>
                                    <p class="section-subtitle">
                                        {t!(
                                            lang, "Choose colors, calculate hand ergonomics, and listen to switch click acoustics.", "Chọn màu sắc, ước tính kích thước tay công thái học và nghe thử âm thanh switch."
                                        )}
                                    </p>
                                </div>
                                ...
                                <div
                                    class="tabs-nav"
                                    style="display: flex; justify-content: center; gap: 15px; margin-bottom: 30px; flex-wrap: wrap;"
                                >
                                    <button
                                        on:click=move |_| set_active_tab.set(ActiveTab::Customizer)
                                        type="button"
                                        class=move || {
                                            if active_tab.get() == ActiveTab::Customizer {
                                                "btn btn-primary"
                                            } else {
                                                "btn btn-secondary"
                                            }
                                    ...
                                    <button
                                        ...
                                        type="button"
                                        class=move || {
                                            if active_tab.get() == ActiveTab::Estimator {
                                                "btn btn-primary"
                                            } else {
                                                "btn btn-secondary"
                                            }
                                    ...
                                    <button
                                        ...
                                        type="button"
                                        class=move || {
                                            if active_tab.get() == ActiveTab::SoundTest {
                                                "btn btn-primary"
                                            } else {
                                                "btn btn-secondary"
                                            }
                                    ...
                                    >
                                        {t!(
                                            lang, "Switch Sound Acoustics", "Thử âm thanh switch"
                                        )}
                                    </button>
                                </div>
                                ...
                                <div class="tab-content" style="max-width: 800px; margin: 0 auto;">
                                    {move || match active_tab.get() {
                                        ActiveTab::Customizer => {
                                            view! {
                                                <KeyboardCustomizer lang=lang product_name=name.clone() />
                                            }
                                                .into_any()
                                        }
                                        ActiveTab::Estimator => {
                                            view! { <HandEstimator lang=lang /> }.into_any()
                                        }
                                        ActiveTab::SoundTest => {
                                            view! { <SoundTestPlayer lang=lang /> }.into_any()
                                        }
                                    }}
                                </div>
                            </div>
                            ...
                            <div class="product-details-container">
                                ...
                                {desc
                                    ...
                                    .enumerate()
                                    .map(|(idx, block)| {
                                        let block_img = images_detail
                                            .get(idx)
                                            .or_else(|| images_detail.first())
                                            .cloned()
                                            .unwrap_or_default();
                                        let is_even = idx % 2 == 0;
                                        let (title, content) = if let Some((t, c)) = block
                                            .split_once('\n')
                                        {
                                            if t.ends_with(':') {
...
fn AboutPage() -> impl IntoView {
    ...
    view! {
        <SeoHead
            ...
            description="Learn how open-diy combines open-source keyboard designs with precise 3D printing, ergonomic layouts, and DIY-friendly hardware support."
                .to_string()
        ...
        <div class="about-section">
            ...
            <img
                ...
                alt="Close-up of a 3D printed Alice keyboard case"
                class="about-image"
                loading="lazy"
                decoding="async"
            />
            ...
            <div class="about-body">
                ...
                <h2 style="font-size: 1.75rem; margin-top: 15px;">
                    {t!(
                        lang, "Additive Manufacturing Specs", "Thông số sản xuất bồi đắp"
                    )}
                </h2>
                <ul class="specs-list">
                    <li>
                        ...
                        <span>
                            {t!(
                                lang, "0.2mm high-precision layers", "Lớp in độ chính xác cao 0.2mm"
                            )}
                        </span>
                    </li>
                    <li>
                        ...
                        <span>
                            {t!(
                                lang, "5 outer perimeters for structural mass", "5 lớp thành ngoài để gia tăng khối lượng cấu trúc"
                            )}
                        </span>
                    </li>
                    <li>
                        ...
                        <span>
                            {t!(
                                lang, "25% acoustic Gyroid infill pattern", "Họa tiết xương Gyroid mật độ 25% tối ưu âm học"
                            )}
                        </span>
                    </li>
                    <li>
                        ...
                        <span>
                            {t!(
                                lang, "Industrial active-heated enclosures", "Buồng sấy in chủ động công nghiệp"
                            )}
                        </span>
                    </li>
                </ul>
                ...
                <div class="glass-card" style="margin-top: 24px; padding: 20px;">
                    <h3 style="margin-bottom: 12px;">
                        {t!(
                            lang, "Good fit for shoppers who want", "Phù hợp cho những khách hàng tìm kiếm"
                        )}
                    </h3>
                    <ul class="specs-list">
                        <li>
                            <span>
                                {t!(
                                    lang, "An ergonomic keyboard that is fully customizable", "Một bàn phím công thái học có khả năng tùy biến hoàn toàn"
                                )}
                            </span>
                        </li>
                        <li>
                            <span>
                                {t!(
                                    lang, "A 3D printed keyboard case with premium finish options", "Vỏ bàn phím in 3D với các tùy chọn bề mặt hoàn thiện cao cấp"
                                )}
                            </span>
                        </li>
                        <li>
                            <span>
                                {t!(
                                    lang, "A path from DIY open-source parts to a finished order", "Một con đường từ các linh kiện nguồn mở DIY đến sản phẩm hoàn thiện"
                                )}
                            </span>
                        </li>
                    </ul>
                ...
                <div style="text-align: center; margin-top: 30px;">
                    <a
                        href="https://github.com/leptos-rs/start-axum"
                        target="_blank"
                        rel="noopener noreferrer"
                        class="btn btn-secondary"
            ...
            if is_open.get() {
                view! {
                    <div class="glass-card ai-chat-window">
                        ...
                        // Messages list
                        <div
                            style="flex: 1; padding: 16px; overflow-y: auto; display: flex; flex-direction: column; gap: 12px; text-align: left;"
                            id="ai-chat-messages"
                        >
                            {move || {
                                messages
                                    ...
                                    .map(|msg| {
                                        ...
                                        view! {
                                            <div style=format!(
                                                "align-self: {}; max-width: 80%; background: {}; color: {}; padding: 10px 14px; border-radius: {}; font-size: 0.85rem; line-height: 1.4; border: {}",
                                                align,
                                                bg,
                                                text_color,
                                                rounded,
                        ...
                        <div style="padding: 8px 16px; display: flex; gap: 6px; flex-wrap: wrap; border-top: 1px solid rgba(255,255,255,0.03); justify-content: flex-start;">
                            ...
                            <button
                                on:click=move |_| send_suggestion(
                                    "Tìm hiểu phím Dactyl-Manuform",
                                )
                                type="button"
                                style="background: rgba(255,255,255,0.03); border: 1px solid var(--border-color); border-radius: 20px; padding: 4px 10px; font-size: 0.72rem; color: var(--secondary); cursor: pointer; transition: all 0.2s;"
                            >
                            ...
                            <button
                                on:click=move |_| send_suggestion(
                                    "Chính sách đặt cọc và mua hàng",
                                )
                                type="button"
                                style="background: rgba(255,255,255,0.03); border: 1px solid var(--border-color); border-radius: 20px; padding: 4px 10px; font-size: 0.72rem; color: var(--secondary); cursor: pointer; transition: all 0.2s;"
                            >
...
fn NotFoundPage() -> impl IntoView {
    ...
    view! {
        ...
        <div class="checkout-page">
            <h1 class="gradient-text">
                {t!(lang, "404 - Page Not Found", "404 - Không tìm thấy trang")}
            </h1>
            <p>
                {t!(
                    lang, "The keyboard you are looking for has been disassembled.", "Bàn phím bạn đang tìm kiếm đã bị rã linh kiện."
                )}
            </p>
    ...
    view! {
        <footer>
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    ...
                    <ul class="footer-links">
                        <li>
                            <A href="/">{move || t!(lang, "Shop", "Cửa hàng")()}</A>
                        </li>
                        <li>
                            <A href="/about">{t!(lang, "Philosophy", "Triết lý")}</A>
                        </li>
                        <li>
                            <a
                                href="https://shopee.vn/opendiy"
                ...
                <div class="footer-col">
                    ...
                    <ul class="footer-links">
                        <li>
                            <a
                                href="https://www.facebook.com/1111759575360830"
                                target="_blank"
                                rel="noopener noreferrer"
                                style="display: inline-flex; align-items: center; gap: 8px;"
                            >
                        ...
                        <li>
                            <a
                                href="https://www.youtube.com/@opendiyvn"
                                target="_blank"
                                rel="noopener noreferrer"
                                style="display: inline-flex; align-items: center; gap: 8px;"
                            >
                ...
                <div class="footer-col">
                    ...
                    <p style="margin-bottom: 10px;">
                        {t!(lang, "Prusa XL CoreXY Farms", "Trang trại máy in Prusa XL CoreXY")}
                    </p>
                    <p style="margin-bottom: 10px;">
                        {t!(
                            lang, "Polymaker PETG/ASA filaments", "Sợi nhựa Polymaker PETG/ASA"
                        )}
                    </p>
            ...
            <div class="footer-bottom">
                <p>
                    {t!(
                        lang, "© 2026 open-diy. Released under MIT Licence.", "© 2026 open-diy. Phát hành dưới Giấy phép MIT."
                    )}
                </p>
...
fn OtelTestPage() -> impl IntoView {
    ...
    view! {
        <div
            class="otel-test-container"
            style="max-width: 800px; margin: 40px auto; padding: 20px; font-family: sans-serif;"
        >
            <h1 class="gradient-text" style="font-size: 2.5rem; margin-bottom: 20px;">
                {t!(
                    lang, "OpenTelemetry Web SDK Test Suite", "Bộ Thử Nghiệm OpenTelemetry Web SDK"
                )}
            </h1>
            ...
            <div style="display: grid; grid-template-columns: 1fr; gap: 20px;">
                ...
                <div style="border: 1px solid var(--border); padding: 20px; border-radius: 12px; background: rgba(255, 255, 255, 0.03); backdrop-filter: blur(10px);">
                    <h3 style="margin-top: 0; display: flex; align-items: center; gap: 8px;">
                        ...
                        {t!(
                            lang, "Document Load & Performance Metrics", "Tải trang & Chỉ số Hiệu năng"
                        )}
                    </h3>
                ...
                <div style="border: 1px solid var(--border); padding: 20px; border-radius: 12px; background: rgba(255, 255, 255, 0.03); backdrop-filter: blur(10px);">
                    <h3 style="margin-top: 0; display: flex; align-items: center; gap: 8px;">
                        ...
                        {t!(
                            lang, "Fetch Request Instrumentation", "Tự động Trace Yêu Cầu Fetch"
                        )}
                    </h3>
                    <p style="font-size: 0.9rem; color: var(--text-muted); line-height: 1.5; margin-bottom: 15px;">
                        {t!(
                ...
                <div style="border: 1px solid var(--border); padding: 20px; border-radius: 12px; background: rgba(255, 255, 255, 0.03); backdrop-filter: blur(10px);">
                    <h3 style="margin-top: 0; display: flex; align-items: center; gap: 8px;">
                        ...
                        {t!(
                            lang, "Grafana Faro RUM Instrumentation", "Thử Nghiệm Grafana Faro RUM"
                        )}
                    </h3>
                    <p style="font-size: 0.9rem; color: var(--text-muted); line-height: 1.5; margin-bottom: 15px;">
                        {t!(
